...
public class BbsController {
	...
	// 공지사항 목록
	/*
	 * @RequestMapping("/bbs/notice_list.do") // public String notice_list()
	 * throws Exception { // return "/bbs/notice_list"; // }
	 * 
	 * @RequestMapping("/bbs/notice_write.do") public String notice_write() throws
	 * Exception { return "/bbs/notice_write"; }
	 * 
	 * @RequestMapping("/bbs/notice_view.do") public String notice_view() throws
	 * Exception { return "/bbs/notice_view"; }
	 */
